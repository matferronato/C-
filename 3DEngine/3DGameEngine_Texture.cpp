...
struct mesh {
    ...
    bool LoadFromObjectFile(string sFilename, bool bHasTexture = false) {
        ...
        vector<vec2d> texs; //locally stores textures
        while (!f.eof()) {
...
public: OlcEngine3D() {
    m_sAppName = L"3D Demo";
          ...
          for (auto tri : meshCube.tris) {
              ...
              if (Vector_DotProduct(normal, vCameraRay) < 0.0f) {
                  ...
                  for (int n = 0; n < nClippedTriangles; n++) {
                      ...
                      //relationship between texture and screen 
      ...
      void TexturedTriangle(int x1, int y1, float u1, float v1, float w1,
          ...
          float tex_u, tex_v, tex_w; //final vector point to sample
          ...
          dx1 = x2 - x1; dy1 = y2 - y1; du1 = u2 - u1; dv1 = v2 - v1; dw1 = w2 - w1;
          dx2 = x3 - x1; dy2 = y3 - y1; du2 = u3 - u1; dv2 = v3 - v1; dw2 = w3 - w1;
